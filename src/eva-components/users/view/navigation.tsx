...
const menuItems = [
  ...
  {
    label: 'Events',
    value: '/user/exhibitors/${id}/exhibitors-events',
    path_type: 'events',
  },
  {
    label: 'Profile Survey',
    value: '/user/exhibitors/${id}/exhibitors-profile-surveys',
    path_type: 'profile-surveys',
  },
  {
    label: '1-1 Meeting Schedules',
    value: '/user/exhibitors/${id}/1-1-meeting-schedules',
    path_type: '1-1-meeting-schedules',
  },
  {
    label: 'Meeting Management',
    value: '/user/exhibitors/${id}/meeting-management',
    path_type: 'meeting-management',
  },
];

export default function UsersHeaderNav({
  handleMenuClick,
}: {
  handleMenuClick: (pathType: string) => void;
}) {
  ...
  let navigation_type = userDetails?.navigation_type;

  if (navigation_type === '1') {
    navigation_type = '1-1-meeting-schedules';
  } else if (navigation_type === 'meeting') {
    navigation_type = 'meeting-management';
  }
