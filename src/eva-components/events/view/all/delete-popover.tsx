...
export default function DeletePopover({
  ...
  const onClickDelete = async (id: string, setOpen: any) => {
    ...
    console.log('getEventParamsDetails>>', paramsDetails);

    setState({
      ...state,
      isLoading: true,
    });
    let removeUserData = { [paramsDetails?.user_api_data_send_type]: [id] };
    let res = await EventsApiServices.RemoveUser(
      removeUserData,
    ...
    switch (res?.response_code) {
      case ResponseCodes.UPDATE_SUCCESS:
        // onClose();
        toast.success('Users remove successfully.');
