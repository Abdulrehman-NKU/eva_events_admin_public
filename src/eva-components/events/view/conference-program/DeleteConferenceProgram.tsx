...
export default function DeleteConferenceProgram({
  title,
  description,
  id,
}: DeletePopoverProps) {
  ...
  const onClickDelete = async (id: string, setOpen: any) => {
    ...
    let res = await EventsApiServices.deleteConferenceProgram(id);
    console.log('res-remove>>>', res);
    switch (res?.response_code) {
      case ResponseCodes.DELETE_SUCCESS:
        toast.success('Conference Program Delete successfully.');
