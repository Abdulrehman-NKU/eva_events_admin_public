...
export default function ConferenceProgramCreate() {
  const createConferenceModal = useSelector(
  ...
  const onSubmitHandler = async (values: any) => {
    ...
    let res =
      await EventsApiServices.createEventConferenceProgram(programsData);
    switch (res?.response_code) {
      case ResponseCodes.CREATE_SUCCESS:
        onClose();
        formik.resetForm();
        // toast.success(res?.data?.message);
        toast.success('Conference Program Create successfully.');
