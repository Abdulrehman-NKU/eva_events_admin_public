...
const menuItems = [
  ...
  {
    label: 'Attendee Delegates',
    type: 'delegates',
  },
  {
    label: 'Attendee Exhibitors',
    type: 'exhibitors',
  },
  {
    label: 'Attendee Sponsors',
    type: 'sponsors',
  },
  {
    label: 'Attendee Speakers',
    type: 'speakers',
  },
  {
    label: 'Attendee Media partners',
    type: 'media-partners',
  },
];

export default function ConferenceEventNav() {
  ...
  let { conference_program_id, event_id, conference_event_type } =
    EventParamsdata.getConferenceView(pathname);
  //  ;
  return (
    <div
      className={cn(
