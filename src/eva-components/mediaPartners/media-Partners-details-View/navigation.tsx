...
const menuItems = [
  {
    label: 'Meadia Partners Details',
    value: '/user/media-partners/${id}/meadia-partners-details',
  },
  {
    label: 'Events',
    value: '/user/media-partners/${id}/meadia-partners-events',
  },
];

export default function MediaPartnersHeaderNav() {
