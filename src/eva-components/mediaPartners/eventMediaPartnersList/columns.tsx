...
export const getColumns = ({
  ...
  },
  {
    ...
    width: 100,
    render: (_: string, row: ProductType) => (
      <DateCell date={new Date(row?.date)} />
    ),
  },
...

  {
    ...
    render: (_: string, row: ProductType) => (
      <Button
        tag="span"
        className="cursor-pointer text-sm dark:bg-gray-100 dark:text-white"
      >
        {row?.event}
      </Button>
    ),
    ...
    render: (_: string, row: ProductType) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        <DeletePopover
          ...
          description={`Are you sure you want to delete this media partner?`}
