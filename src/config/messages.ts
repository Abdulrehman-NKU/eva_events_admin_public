export const messages = {
  ...
  optionTitleIsRequired: 'Option title is required',
  answereIsRequired: 'Answere is required',
  selectSurveySectionRequired: 'Select Survey Section is required',

  jobTitleIsRequired: 'Job title is required',

  networkingEventIsRequired: 'Networking event name is required',

  urlIsRequired: 'URL is required',
  sponsorsTypeRequired: 'Sponsors type is required',
